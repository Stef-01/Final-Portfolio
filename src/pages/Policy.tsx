    ...
    <div className="min-h-[100svh] bg-white text-gray-900 py-16 md:py-20 px-4 md:px-8">
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <span className="font-['Clash_Grotesk:Medium',_sans-serif] text-[18px]">
            Back to Home
          </span>
        </Link>
        ...
        >
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div
                key={item}
                className="rounded-[28px] border border-black/8 bg-[#fafafa] px-5 py-5 text-sm md:text-base font-medium text-gray-700 shadow-[0_18px_45px_-38px_rgba(0,0,0,0.5)]"
              >
                {item}
              </div>
            ))}
