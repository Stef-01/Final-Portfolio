      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          <div className="mb-12">
            ...
            <p className="font-['Clash_Grotesk:Regular',_sans-serif] text-[24px] text-gray-300 mb-4">
              Early Career Researcher, Public Servant, and Medical Student
            </p>
            <div className="flex gap-6 text-[18px] text-gray-400">
              <a href="mailto:stefan@example.com" className="flex items-center gap-2 hover:text-[#EBFF57] transition-colors">
                <Mail className="w-5 h-5" />
                Email
              </a>
              <a href="#" className="flex items-center gap-2 hover:text-[#EBFF57] transition-colors">
          ...
          <section className="mb-16">
            <div className="flex items-center gap-3 mb-8">
              <GraduationCap className="w-8 h-8 text-[#EBFF57]" />
            ...
            >
              <div className="border-l-4 border-[#EBFF57] pl-6 py-4">
                <h3 className="font-['Clash_Grotesk:Medium',_sans-serif] text-[28px] mb-2">
                  M.S. in Community Health and Prevention Research
                </h3>
                <p className="text-[#EBFF57] text-[20px] mb-2">Stanford University</p>
                <p className="text-gray-400 text-[18px] mb-3">2025-2026 | GPA: 4.075/4.3</p>
                <p className="text-gray-300 text-[18px] leading-relaxed mb-2">
                ...
                <p className="text-gray-400 text-[16px] mt-2">Advisor: Prof. Palaniappan</p>
              </div>
              ...
              <div className="border-l-4 border-[#EBFF57] pl-6 py-4">
                ...
                <p className="text-[#EBFF57] text-[20px] mb-2">Macquarie University</p>
                <p className="text-gray-400 text-[18px] mb-3">2023-2027</p>
                <p className="text-gray-300 text-[18px] leading-relaxed">
              ...
              <div className="border-l-4 border-[#EBFF57] pl-6 py-4">
                ...
                <p className="text-[#EBFF57] text-[20px] mb-2">Australian National University</p>
                <p className="text-gray-400 text-[18px] mb-3">2019-2023 | GPA: 6.92/7.0</p>
              </div>
            </motion.div>
          </section>
          ...
          <section className="mb-16">
            <div className="flex items-center gap-3 mb-8">
              <Briefcase className="w-8 h-8 text-[#EBFF57]" />
            ...
            >
              <div className="bg-[#0a0a0c] border border-[rgba(255,255,255,0.1)] rounded-2xl p-6">
                <h3 className="font-['Clash_Grotesk:Medium',_sans-serif] text-[24px] mb-4">Current Research Areas</h3>
                <ul className="space-y-3 text-gray-300 text-[18px]">
          ...
          <section className="mb-16">
            <div className="flex items-center gap-3 mb-8">
              <Trophy className="w-8 h-8 text-[#EBFF57]" />
            ...
            >
              <div className="border-l-4 border-[#EBFF57] pl-6 py-4">
                ...
                <p className="text-gray-400 text-[18px] mb-3">2024</p>
                <p className="text-gray-300 text-[18px] leading-relaxed">
              ...
              <div className="border-l-4 border-[#EBFF57] pl-6 py-4">
                ...
                <p className="text-gray-400 text-[18px] mb-3">2023</p>
                <p className="text-gray-300 text-[18px] leading-relaxed">
              ...
              <div className="border-l-4 border-[#EBFF57] pl-6 py-4">
                ...
                <p className="text-gray-400 text-[18px] mb-3">2020 & 2022</p>
              </div>
              ...
              <div className="border-l-4 border-[#EBFF57] pl-6 py-4">
                ...
                <p className="text-gray-400 text-[18px] mb-3">2022</p>
                <p className="text-gray-300 text-[18px] leading-relaxed">
          ...
          <section>
            <div className="flex items-center gap-3 mb-8">
              <Award className="w-8 h-8 text-[#EBFF57]" />
            ...
            >
              {[
                ...
                <motion.div
                  key={skill}
                  className="bg-[#0a0a0c] border border-[rgba(255,255,255,0.1)] rounded-lg px-6 py-4 text-center"
