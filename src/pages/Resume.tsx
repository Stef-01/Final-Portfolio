        ...
        >
          <div className="mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 text-[16px] md:text-[18px] text-gray-500">
              <a href="mailto:stefan01@stanford.edu" className="flex items-center gap-2 hover:text-blue-600 transition-colors">
                <Mail className="w-5 h-5" />
                stefan01@stanford.edu
              </a>
              <a href="https://scholar.google.com/citations?user=9Nxhv58AAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-blue-600 transition-colors">
          ...
          <section className="mb-16">
            ...
            >
              ...
              <div className="border-l-4 border-blue-600 pl-6 py-4">
                ...
                <p className="text-gray-500 text-[16px] md:text-[18px] mb-3">2023-2027</p>
                <p className="text-gray-700 text-[16px] md:text-[18px] leading-relaxed">
              ...
              <div className="border-l-4 border-blue-600 pl-6 py-4">
                ...
                <p className="text-gray-500 text-[16px] md:text-[18px] mb-3">2019-2023 | GPA: 6.92/7.0</p>
              </div>
            </motion.div>
          </section>
