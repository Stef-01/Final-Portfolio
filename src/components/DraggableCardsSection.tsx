                ...
                <div className="relative w-full h-full">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                        <div className="text-center text-white px-4">
                            ...
                            <div className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-md rounded-3xl px-12 py-8 border border-white/25 shadow-2xl">
                                <h1 className="text-6xl md:text-8xl font-bold tracking-tighter leading-tight mb-4 drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)] text-white">
                                    On a quest to craft<br />something awesome
                                </h1>
                                <p className="text-2xl md:text-3xl font-serif italic opacity-95 drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)] text-white">
